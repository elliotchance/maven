...
MAVEN_DECL int         findFunctionID(MavenCompiler* c, int namespaceID, int objectID, string function, MavenVariables args, bool strict = false);
MAVEN_DECL string      findFunctionPath(MavenCompiler* c, string entity, MavenVariables args, int& namespaceID, int& objectID, int& funcID);
...
MAVEN_DECL string      findVariablePath(MavenCompiler* c, string entity, int& namespaceID, int& objectID, int& variableID);
